...
Date: 02/08/2021
Purpose: Use scanf to take user input and use if-else to determine if odd or even, and then complete an equation
Sources of Help: PDF and my brain
Time Spent: About 10-15 min
***********************************************/
...
int main(int argc, char * argv[]){
    ...
    // Display message to enter int, and accept with scanf
    printf("Please enter a positive integer: ");
    scanf("%d", &number);
    
    // If-Else to determin if odd or even
    if(number %2 == 0){
        number /= 2;
